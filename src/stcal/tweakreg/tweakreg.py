...
def tweakreg(images: ModelContainer, catalogs: list[Table],
             ref_cat: Table = None,
             abs_refcat: str | None = None,
             ...
             sip_npoints: int = 12,) -> ModelContainer:
    """
    whatever.

    Parameters
    ----------
    ref_cat: only required when align_to_abs_refcat is True
    """
