...
def default_twopt_p(rej=3, _1drej=3, _3drej=3, nframes=1, _4n=False, mx_flag=200, mn_flag=10):
...
def test_varying_groups():
    ...
    out_gdq, row_below_gdq, rows_above_gdq, total_crs, stddev = find_crs(data, gdq, read_noise, twopt_p)
...
def test_6grps_cr2_nframe2():
    ...
    twopt_p = default_twopt_p(rej=3, _1drej=3, _3drej=3, nframes=2, _4n=False, mx_flag=200, mn_flag=10)
...
def set_sigma_clip_data(data):
    base_arr = np.array(
        [
            [10.731703, 27.203512, 106.22826, 151.0139, 212.16364, 258.99268, 288.5518, 347.3305, 415.43622],
            [81.00812, 126.25662, 182.64836, 222.33426, 271.6754, 313.7703, 340.5042, 383.5762, 440.76724],
            [
                25.141754,
                44.785824,
                90.29829,
            ...
            [42.45757, 87.34434, 120.69542, 181.82999, 230.85397, 283.2989, 322.58997, 359.593, 413.067],
            [
                -20.901432,
                21.450695,
                74.89305,
            ...
            [-45.09379, 3.33447, 75.925735, 117.744316, 141.13106, 216.48933, 242.42192, 298.9422, 360.00977],
            [17.00263, 76.606064, 99.686714, 134.43599, 222.63557, 262.86624, 273.09332, 314.8982, 374.4669],
            [35.92628, 100.91746, 146.84523, 191.37482, 223.67198, 284.9848, 321.36685, 405.71707, 423.96967],
            [49.854065, 52.88707, 101.63217, 152.14273, 185.52617, 261.91086, 283.9805, 348.89255, 395.10388],
            [46.19449, 95.038574, 136.92563, 213.52617, 255.4488, 285.599, 353.41556, 398.4853, 450.24988],
            [
                20.631287,
                6.7477093,
                87.05258,
            ...
            [44.94166, 79.9948, 152.88118, 189.57803, 232.15485, 284.44135, 295.0025, 362.4202, 408.2485],
            [49.948082, 76.186874, 114.14371, 181.95833, 215.66791, 263.49374, 318.52133, 375.40717, 424.171],
            [33.684372, 57.108395, 99.87311, 158.9294, 207.78914, 310.25403, 349.13037, 380.33728, 423.91754],
            [0.8763512, 57.26083, 98.34808, 149.68803, 200.28212, 258.59805, 300.5317, 331.96344, 372.13153],
        ],
        dtype=np.float32,
    )
